...
const MainPresentation = () => {
  ...
  return (
    ...
    >
      <div
        className={`w-full h-[300vh] md:h-[300vh] bg-black  flex flex-col max-md:bg-[10%]`}
        style={{
      ...
      >
        ...
        <p className="text-[#F7F7F7] text-3xl md:text-5xl font-normal w-2/3 md:w-1/3 h-[200px] self-start sticky top-96 md:top-[27rem] pl-5 md:mb-20 lg:mb-0">
      ...
      >
        <motion.p
          className="text-9xl text-black mt-36  text-end max-md:text-7xl"
          style={{ x: pX }}
        ...
        <motion.p
          className=" text-3xl text-black max-md:pt-36 md:text-5xl font-normal pl-5"
          style={{ x: pX }}
          animate={{ y: ["100%", "0%"], opacity: [0, 0.5, 1] }}
          transition={{ duration: 1, ease: "easeInOut" }}
        >
